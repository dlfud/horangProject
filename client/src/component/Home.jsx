            ...
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              ...
              {onoff ? (
                <>
                  ...
                  <li className="rounded-sm">
                    <Link to="/secrethome" className="flex items-center p-2 space-x-3 rounded-md">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-8 h-8 "
                        fill="none"
                  ...
                  <li className="rounded-sm">
                    <a onClick={handleLogout} className="flex items-center p-2 space-x-3 rounded-md">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-8 h-8"
                        fill="none"
                ...
                <>
                  ...
                  <li className="rounded-sm">
                    <Link to="/join" className="flex items-center p-2 space-x-3 rounded-md">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="w-8 h-8"
                        fill="none"
